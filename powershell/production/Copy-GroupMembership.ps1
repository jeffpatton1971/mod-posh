<#
    ...
    .EXAMPLE
        .\Copy-GroupMembership.ps1 -NewUser 'Newton' -ExistingUser 'Oldson' -ADSPath 'CN=ForeignSecurityPrincipals,DC=company,DC=com'
    ...
    .EXAMPLE
        .\Copy-GroupMembership.ps1 -NewUser 'Guest' -ExistingUser 'krbtgt' -ADSPath 'DC=company,DC=com' -SearchFilter '(objectCategory=Person)'
