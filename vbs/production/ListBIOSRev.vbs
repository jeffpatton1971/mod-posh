...
'
' This script searches through Active Directory and connects
' to each computer object returned and queries for its BIOS
' revision.
'
...
Sub QueryAD(strQuery)
	...
	If Err <> 0 Then 
		Call LogData(1, "Unable to connect using the provided query: " & vbCrLf & strQuery)
		Wscript.Quit
		Err.Clear
	End If
	...
	'
		...
		Do Until objRecordSet.EOF
			...
			Wscript.Echo "SMBIOSBIOSVersion: " & GetWMIData(objRecordSet.Fields("Name"), "Win32_BIOS", "SMBIOSBIOSVersion")
